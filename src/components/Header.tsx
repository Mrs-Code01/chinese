  ...
  return (
    <header className="sticky top-0 z-20 border-b border-neutral-200 bg-white/90 backdrop-blur dark:border-neutral-800 dark:bg-neutral-950/90">
      <div className="mx-auto flex max-w-6xl items-center gap-3 px-4 py-3 sm:gap-4">
        ...
        <nav className="hidden flex-wrap items-center gap-x-4 gap-y-1 text-sm font-medium text-neutral-600 dark:text-neutral-300 lg:flex">
          {NAV_LINKS.map((link) => (
            <Link
              key={link.href}
              href={link.href}
        ...
        <div className="flex flex-1 items-center justify-end gap-2">
          <div className="min-w-0 flex-1 sm:max-w-xs lg:max-w-72">
          ...
          <button
            ...
            className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-neutral-300 text-lg text-neutral-600 transition hover:border-brand-300 hover:text-brand-600 lg:hidden dark:border-neutral-700 dark:text-neutral-300 dark:hover:text-brand-400"
          >
            {menuOpen ? "✕" : "☰"}
          </button>
        </div>
      ...
      {menuOpen && (
        <nav className="border-t border-neutral-200 px-4 py-3 lg:hidden dark:border-neutral-800">
